...
mod test {
    ...
    fn test_push_int() {
        ...
        witness.push_int(1); assert_eq!(witness.last().unwrap(), &[0x51]);
        witness.push_int(0); assert_eq!(witness.last().unwrap(), &[0x00]);
        witness.push_int(16); assert_eq!(witness.last().unwrap(), &[0x60]);
        ...
        witness.push_int(-1); assert_eq!(witness.last().unwrap(), &[0x4f]);
